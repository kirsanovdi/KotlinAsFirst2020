...
fun main() {
    ...
    println("Root product: ${numberRevert(12345)}")
}
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + (sec / 60.0 + min) / 60.0) / 180 * PI
...
fun numberRevert(number: Int): Int {
    var numberReversed: Int = 0
    var numberTemplate: Int = number
    while (numberTemplate > 0) {
        numberReversed *= 10
        numberReversed += numberTemplate % 10
        numberTemplate /= 10
    }
